...
<!-- One or two sentences. What does the specification say now that it did not before? -->
...
<!-- Does this change the NodeSet? If so, say whether Version and PublicationDate moved,
     and whether NodeIds were appended rather than inserted — a mid-file insert silently
     renumbers everything after it. Write "none" if the model is untouched. -->
